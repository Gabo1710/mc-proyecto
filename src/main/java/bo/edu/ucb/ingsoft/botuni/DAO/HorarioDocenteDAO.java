...
public interface HorarioDocenteDAO {
    @Select("SELECT a.materia_detalle_id as id, d.siglas as siglas, d.materia as materia, a.hora_inicio as horainicio, a.hora_fin as horafin, f.codigo_aula as aula, a.paralelo as paralelo, a.dia as dia, a.docente_id " +
            ...
            "WHERE " +
            " c.bot_chat_id = #{id}")
    List<HorarioDocenteDTO> findHorarioDocenteByBotChatId(@Param("id")String botchatId);
}