...
public class DetalleDTO {
    ...
    public  DetalleDTO(Integer materiaDetalleId, MateriaDTO materiaId, AulaDTO aulaId, DocenteDTO docenteId, Time horaInicio, Time horaFin, String paralelo, String dia) {
