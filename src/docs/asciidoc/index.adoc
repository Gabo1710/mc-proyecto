...
### 1 - Consulta de horario y aulas (DOCENTE)
...
*10.1.1 Docente ingresa siglas o comando incorrectos.*
...
*10.1.2 Docente no se encuentra registrado*
...
*10.1.3 Docente se encuentra registrado*
...
*10.1.4 Docente ingresa datos correctos*
...
### 2 - Consultar listado de Alumnos por clase

*Autor*: Moises Carlos Valda Gutiérrez
...
* Enviar el comando /SolicitarLista

El diagrama de secuencia para esta Historia es el siguiente:

[plantuml, format="png", id="estados_Consulta_lista"]
...
Docente -[#red]> BOT: /start
BOT -[#blue]-> Docente: '¿Qué desea?'
Docente -[#red]> BOT: /SolicitarLista
BOT -[#blue]-> Docente: 'Ingrese Sigla de la materia'
Docente -[#red]> BOT: Ingresa sigla de la materia

database BBDD #brown

BOT -[#green]-> BBDD: 'Realiza consulta'
BBDD -[#green]-> BOT: 'Información requerida '
BOT -[#blue]-> Docente: 'Genera y muestra la Lista de la materia'
...
*20.1.1 Docente no se encuentra registrado.*
...
*20.1.2 Docente ingresa comando no válido.*
...
*20.1.3 Docente ingresa comando válido.*
...
- *Resultado esperado:* ¿Qué necesita?
- */SolicitarLista*
- *Resultado esperado:* El BOT retorna un mensaje: "Ingrese siglas de la materia".
- *Datos:* 'SiS213'
- *Resultado esperado:* El BOT 'Genera y muestra la Lista de la materia'.
